...
object EscPosPrinterHelper {
    ...
    // ESC/POS Auto-Cutter Command with 8-line hardware feed margin
    private val ESC_FEED_PAPER = byteArrayOf(0x1B, 0x64, 0x08)   // ESC d 8 (Feed 8 lines for extra cutter distance)
    private val CUT_GS_V_66 = byteArrayOf(0x1D, 0x56, 0x42, 0x00) // GS V 66 0 (Cut paper)
