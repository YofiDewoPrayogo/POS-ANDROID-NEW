...
# Replace version=6 to version=7
content = content.replace("version = 6,", "version = 7,")

new_populate = """        suspend fun populateInitialData(db: PosDatabase) {
...
content = re.sub(r"suspend fun populateInitialData\(db: PosDatabase\).*?\}\n        \}", new_populate + "\n    }", content, flags=re.DOTALL)
